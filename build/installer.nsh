...
!macro customWelcomePage
  !define MUI_WELCOMEPAGE_TITLE "Welcome to GPT Kampli Library Manager"
...
!macro customPageAfterChangeDir
  ...
  Function instFilesShowIfUpdate_${InstShowUID}
    ${if} ${isUpdated}
      !insertmacro MUI_HEADER_TEXT "Updating GPT Kampli Library Manager" "Please wait while the update is being installed..."
