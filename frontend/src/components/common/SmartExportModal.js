...
const SmartExportModal = ({ onClose, onExport, totalCount, selectedCount, filteredCount, entityName = "Items" }) => {
                ...
                <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            <ScopeOption id="all" label={`All ${entityName}`} count={totalCount} icon={Layers} />
