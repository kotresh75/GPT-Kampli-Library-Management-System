        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="glass-panel w-full max-w-md p-6 relative animate-in fade-in zoom-in duration-200">
                <h2 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                    <CheckCircle className="text-green-400" /> {t('circulation.verify_receipt.title')}
                </h2>
                    ...
                    <div className="space-y-4 animate-in slide-in-from-bottom-2">
                        <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
                            <div className="flex justify-between items-start">
                                <div>
                                    <div className="text-xs text-gray-400">{t('circulation.verify_receipt.student')}</div>
                                ...
                                <div className="text-right">
                                    <div className="text-xs text-gray-400">{t('circulation.verify_receipt.date')}</div>
                            ...
                            <div className="border-t border-white/10 my-2 pt-2 flex justify-between items-center">
                                <span className="text-gray-400">{t('circulation.verify_receipt.total_paid')}</span>
